  ...
  useEffect(() => {
    const fetchServices = async () => {
      try {
        ...
        setError("Xidmətlər yüklənərkən xəta baş verdi");
    ...
    <div className="py-16 min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <p className="text-lg text-white/80 text-center mb-12 max-w-2xl mx-auto">
          Biznesiniz üçün ən yaxşı rəqəmsal həlləri və kreativ dizayn xidmətləri
          təklif edirik
        </p>
        ...
        {loading && (
          <div className="flex justify-center items-center py-12">
            ...
            <span className="ml-3 text-white">Xidmətlər yüklənir...</span>
          </div>
        )}
        ...
        {!loading && (
          <div className="flex flex-col md:flex-row items-start gap-8">
            {/* Service Tabs */}
            <div className="flex flex-row md:flex-col flex-wrap md:flex-nowrap justify-center gap-4 md:sticky top-4 z-10 shadow-sm w-full lg:w-1/4">
              {services.map((service) => (
                <Link
                  key={service.id}
            ...
            {/* Service Items */}
            <div className="flex flex-col gap-12 w-full lg:w-full">
              ...
              {services.map((service, idx) => (
                ...
                >
                  <div
                    className={`grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-12 items-center ${
                  ...
                  >
                    ...
                    <div className="p-6 md:p-8">
                      <motion.h3 className="text-2xl font-bold text-gray-900 mb-4 group-hover:text-blue-600 transition-colors duration-300">
                        {service.title}
                      </motion.h3>
