  ...
  return (
    <div className="py-16 min-h-screen bg-gradient-to-br from-[#1e2533] via-[#232b39] to-[#181f2a]">
      <div className="max-w-5xl mx-auto px-4">
        <h1 className="text-4xl md:text-5xl font-extrabold text-center text-white mb-8 tracking-tight drop-shadow-lg">Bloq</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-[#232b39]/90 rounded-2xl p-6 shadow-lg text-center">
            <h2 className="text-xl font-bold text-white mb-2">Blog Post 1</h2>
            <p className="text-gray-300">Məqalə haqqında qısa təsvir.</p>
          </div>
          <div className="bg-[#232b39]/90 rounded-2xl p-6 shadow-lg text-center">
            <h2 className="text-xl font-bold text-white mb-2">Blog Post 2</h2>
            <p className="text-gray-300">Məqalə haqqında qısa təsvir.</p>
          </div>
        </div>
      </div>
