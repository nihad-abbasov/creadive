...
export const metadata: Metadata = {
  ...
  keywords: [
    "Reklam agentliyi",
    "Rəqəmsal reklam agentliyi",
    "Reklam xidmətləri",
    "Reklam xidməti",
    "Reklam xidmetleri",
    "Professional reklam xidmətləri",
    "Reklam dizayn xidmətləri",
    "Reklam xidmeti Azerbaycan",
    "Reklam xidmeti Bakıda",
    "Smm xidmeti",
    "Smm xidmetleri",
    "Smm xidmeti qiymeti",
    "Smm xidmeti nedir",
    "Smm xidməti",
    "Smm xidmeti Azerbaycan",
    "Smm xidmeti agentlik",
    "Smm xidmeti Baki",
    "Smm xidmeti sirketi",
    "Marketing agency",
    "Marketing agentliyi",
    ...
    "Logo hazırlanması",
    "Brendinq agentliyi",
    "E-ticarət saytlarının yığılması",
    "Logo düzəltmək",
    "Logo sifarişi",
    "Veb dizayn xidməti",
    "Rəqəmsal marketinq xidmətləri",
    "Ən yaxşı marketinq agentlikləri",
  ],
